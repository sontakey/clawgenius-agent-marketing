# clawgenius-agent-marketing

Positioning, GTM, content, and campaign strategy agent.

## Install

```bash
hermes profile install github.com/sontakey/clawgenius-agent-marketing --alias --name marketing
```
...
`web, search, file, skills, session_search`

Configure locally after install with:

```bash
hermes -p marketing tools
hermes -p marketing model
```
